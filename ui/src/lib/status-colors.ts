...
export const issueStatusIcon: Record<string, string> = {
  ...
  in_qa: "text-purple-600 border-purple-600 dark:text-purple-400 dark:border-purple-400",
...
export const issueStatusText: Record<string, string> = {
  ...
  in_qa: "text-purple-600 dark:text-purple-400",
...
export const statusBadge: Record<string, string> = {
  ...
  in_qa: "bg-purple-100 text-purple-700 dark:bg-purple-900/50 dark:text-purple-300",
