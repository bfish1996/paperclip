        ...
        <div style={{ display: "grid", gap: "10px", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))" }}>
          ...
          <form
            ...
            onSubmit={(event) => {
              ...
              void advanceIssueStatus({ companyId, issueId: selectedIssueId, status: "in_qa" })
                .then((next) => {
                  setResult(next);
                  return refreshAll();
                })
          ...
          >
            ...
            <button type="submit" style={buttonStyle} disabled={!companyId || !selectedIssueId}>Move to in_qa</button>
          </form>
          <form
            style={layoutStack}
            onSubmit={(event) => {
