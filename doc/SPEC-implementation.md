...
- `title` text not null
- `description` text null
- `status` enum: `backlog | todo | in_progress | in_qa | merging | done | blocked | cancelled`
...
- `in_progress -> in_qa | blocked | done | cancelled`
- `in_qa -> in_progress | merging | done | cancelled`
- `merging -> done | in_progress | cancelled`
