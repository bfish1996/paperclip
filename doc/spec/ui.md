...
**Top toolbar:**
- **Status tabs:** `All Issues`, `Active` (todo + in_progress + in_qa + merging + blocked), `Backlog`. Each tab shows a status icon and count. Active tab is filled, others outlined.
